...
class DragScrollable {
  ...
  _moveHandler(event) {
    ...
    const maxAvailableLeft = (content.currentWidth - viewport.originalWidth) / 2 + content.correctX
    const maxAvailableTop = (content.currentHeight - viewport.originalHeight) / 2 + content.correctY
