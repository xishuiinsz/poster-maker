...
import { calculateAlignPoint, calculateContentMaxShift, calculateContentShift, calculateCorrectPoint, calculateViewportCenter } from './calculator'
...
WZoom.prototype = {
  ...
  _computeScale(direction) {
    ...
    const scale = currentScale + this.direction / this.options.speed
  ...
  _computePosition(scale, x, y) {
    ...
    let contentNewLeft = calculateContentShift(
      x,
      scrollLeft,
    ...
    let contentNewTop = calculateContentShift(
      y,
      scrollTop,
