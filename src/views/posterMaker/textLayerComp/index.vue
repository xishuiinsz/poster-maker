<template>
  ...
  >
    <div
      class="layer-element"
      :class="layerElementClassName"
      v-html="layerData.html"
      @blur.capture="layerElementBlurEvt"
      @mousedown.stop
      @mousemove.stop
      @mouseup.stop="layerElementMouseupEvt"
    ></div>
    <layerZoomBox
      v-bind="propsToLayZoomBox"
      @layZoomBoxMouseupEvt="layZoomBoxMouseupHandler"
...
<script setup lang="ts" name="TextLayerComp">
  ...
  import { getAncestorByClass } from '../utils.js'
